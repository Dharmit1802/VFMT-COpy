        ...
        <div className="flex flex-col w-full px-4 max-w-[1440px] mx-auto items-start gap-8 lg:gap-16 relative">
          ...
          <div className="items-start lg:items-center justify-between flex flex-col lg:flex-row relative w-full gap-8 lg:gap-0">
            ...
            <div className="hidden lg:inline-flex items-center gap-[26px]">
              <button
                onClick={handlePrev}
                className="w-[50px] lg:w-[74px] h-[50px] lg:h-[74px] rounded-full border-2 border-white text-white text-3xl lg:text-[45px] flex items-center justify-center text-center"
                aria-label="Previous"
                type="button"
              >
                <ChevronLeft />
          ...
          <Slider ref={sliderRef} {...settings} className="w-full">
            {serviceCards.map((card, idx) => (
              <div
                key={idx}
                className="flex flex-col w-full sm:w-auto lg:w-[467px] bg-transparent border-none px-2"
              >
                <div className="w-full h-[316px] bg-white rounded-2xl overflow-hidden mx-auto sm:mx-0">
