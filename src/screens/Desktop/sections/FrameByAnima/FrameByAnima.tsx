...
export const FrameByAnima = (): JSX.Element => {
  const featureTabs = [
    { id: "asset", label: "Assest Managment", active: true },
    { id: "investment", label: "Investment Firm", active: false },
    { id: "construction", label: "Construction", active: false },
    { id: "financial", label: "Financial Analysis", active: false },
  ];
        ...
        <div className="flex flex-col w-full px-4 max-w-[1440px] mx-auto items-start gap-8 lg:gap-16 relative">
          ...
          <div className="items-start lg:items-center justify-between flex flex-col lg:flex-row relative w-full gap-8 lg:gap-0">
            ...
            <div className="hidden lg:inline-flex items-center gap-[26px]">
              <button className="w-[50px] lg:w-[74px] h-[50px] lg:h-[74px] rounded-full border-2 border-white text-white text-3xl lg:text-[45px] flex items-center justify-center">
                ‹
              </button>
              <button className="w-[50px] lg:w-[74px] h-[50px] lg:h-[74px] rounded-full border-2 border-white text-white text-3xl lg:text-[45px] flex items-center justify-center">
                ›
          ...
          {/* Cards */}
          <div className="flex flex-wrap lg:flex-nowrap flex-col sm:flex-row items-start lg:items-center gap-[25px] w-full">
            {serviceCards.map((card, index) => (
              <div key={index} className="flex flex-col w-full sm:w-[calc(50%-12.5px)] lg:w-[467px] bg-transparent border-none">
                <div className="w-[100%] sm:w-[358px] lg:w-full h-[316px] bg-white rounded-2xl overflow-hidden mx-auto sm:mx-0">
...
<div className="relative lg:absolute top-0 right-0 w-full lg:w-[45%] h-[361px] lg:h-[500px] mt-8 lg:mt-0">
      ...
      {/* Footer Section */}
      <footer className="relative w-full min-h-[100vh] bg-[#0b1a33] flex flex-col justify-start pt-12 pb-0 lg:pt-0 lg:pb-0">
        <div className="flex flex-col w-full max-w-[1440px] mx-auto items-start gap-[60px] lg:gap-[120px] relative lg:top-[131px] px-4 lg:px-0 lg:left-0">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-[72px] w-full">
            {/* Left: Logo, Desc, Email */}
            <div className="w-full lg:w-[550px] flex flex-col gap-4">
              <div className="flex items-center gap-1 mt-[-1px]">
                <span className="font-bold text-white text-[29.4px] leading-[44px] tracking-[0] font-[Space_Grotesk]">VFMT</span>
                <span className="font-medium text-white text-[42.2px] leading-[44px] font-[Space_Grotesk]">.</span>
              </div>
              ...
              <div className="mt-8 lg:mt-[40px]">
                <span className="font-bold text-white text-3xl lg:text-[55px] leading-[1.2] lg:leading-[66px] font-[Space_Grotesk]">info@email.com</span>
              </div>
            </div>
            {/* Center: Menu */}
            <div className="flex flex-col w-full lg:w-[306px] items-start gap-[25px] pt-0 pb-[1.5px]  px-0">
              {["HOME", "ABOUT", "SERVICES", "PORTFOLIO", "BLOG", "CONTACT US"].map((item, index) => (
                <div key={index} className="inline-flex flex-col items-start">
                  <span className="font-medium text-white text-base leading-6 font-[Space_Grotesk] whitespace-nowrap">{item}</span>
                </div>
              ))}
            </div>
            {/* Right: Contact Info */}
            <div className="relative w-full lg:w-[440px] min-h-[200px]">
              {/* Location */}
              <div className="flex items-start gap-2 absolute top-0 left-0">
                <img className="w-3 h-4 mt-1" alt="Location icon" src="/img.svg" />
                <div className="flex flex-col">
                  <span className="text-[#c1c1c1] text-lg lg:text-[22px] leading-[1.4] lg:leading-[30.8px] font-normal font-[Space_Grotesk]">901 N Pitt Str., Suite 170 Alexandria,<br />NY, USA</span>
                </div>
              </div>
              {/* Phone */}
              <div className="flex items-center gap-2.5 absolute top-[91px] left-0">
              ...
              {/* Email */}
              <div className="flex items-center gap-2.5 absolute top-[154px] left-0">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between w-full gap-4 lg:gap-0">
            <div className="flex items-center gap-5 w-full lg:w-auto">
              <span className="font-medium text-[#c1c1c1] text-base lg:text-lg leading-6 font-[Space_Grotesk] whitespace-nowrap">Terms & Condition</span>
              <span className="font-medium text-[#c1c1c1] text-base lg:text-lg leading-6 font-[Space_Grotesk] whitespace-nowrap">Privacy Policy</span>
            </div>
            <span className="font-medium text-[#c1c1c1] text-base lg:text-lg leading-[1.3] lg:leading-[23.4px] font-[Space_Grotesk] whitespace-nowrap">Copyright @2025, All Right reserved</span>
          </div>
        </div>
        {/* Cityscape SVG for mobile view */}
        <div className="block lg:hidden w-full relative h-[150px] mt-8 overflow-hidden">
          <img
            src="/vector-2.svg"
            alt="Cityscape"
        ...
        {/* Cityscape SVGs for desktop view */}
        <img
          className="hidden lg:block absolute left-[120px] w-[715px] h-[271px] bottom-0"
          alt="Vector"
          src="/vector-2.svg"
        />
        <img
          className="hidden lg:block absolute left-[842px] w-[715px] h-[271px] bottom-0"
          alt="Vector"
          src="/vector-3.svg"
        />
